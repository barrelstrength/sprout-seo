...
class OneSeo_RobotsSeoFieldType extends BaseFieldType
{
    /**
     * FieldType name
     *
    ...
    {   
        ...
        $_POST['oneseo_fields']['robots'] = craft()->oneSeo->prepRobotsArray($_POST['oneseo_fields']['robots']);
    ...
    public function getInputHtml($name, $value)
    {
        ...
        $values = craft()->oneSeo->getRobotsSeoFeildsByEntryId($entryId);
        ...
        return craft()->templates->render('oneseo/_fields/robots', array(
            'name'	     => $name,
            // 'value'      => $value,
            'values'     => $values
        ));
